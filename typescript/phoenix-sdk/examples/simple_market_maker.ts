...
export async function simple_market_maker() {
  ...
  const trader = Keypair.fromSeed(
    Uint8Array.from(
      [
        140, 104, 220, 190, 24, 98, 38, 34, 34, 37, 128, 144, 84, 215, 25, 253,
        21, 185, 176, 73, 156, 36, 28, 133, 120, 57, 160, 112, 170, 205, 242,
        141, 11, 119, 36, 148, 106, 251, 83, 237, 76, 199, 143, 244, 237, 47,
        249, 218, 210, 50, 99, 119, 203, 111, 127, 210, 160, 235, 62, 143, 48,
        8, 206, 88,
      ].slice(0, 32)
    )
  );
